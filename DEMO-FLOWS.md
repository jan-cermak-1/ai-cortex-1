...
**Format (demo flows):** Persona, Scenario, Output page (when applicable), Step table.  
**Format (catalog):** Persona, File, Scenario — reference only, no step-by-step.
...
| 6 | Cortex: analyzing the uploaded file — `users-import-2026.xlsx` |
| 7 | Cortex: found 47 valid records (Name, Email, Department, Role) |
| 8 | Intelligence box appears with import options |
| 9 | Cortex: recommends importing users, creating teams, sending invites, and assigning roles |
| 10 | Check 4 actions: import users, create teams, send invites, assign roles |
| 11 | Click "Execute selected" |
| 12 | Cortex: import complete — 47 users, 6 teams created by department, invitations queued |
| 13 | Navigate to Settings / Users — all users are now visible in the User Management panel |
...
**Output page:** Publisher Calendar / Content Hub
...
| 13 | Two result links appear: Publisher Calendar (Cortex Import badge active), Content Hub collection "Q2 Campaign Assets" |
...
**Output page:** Publisher Calendar / Care Inbox / Unified Analytics
...
**Output page:** Ratings & Reviews / Unified Analytics
...
**Output page:** Settings / Users / Care Inbox
...
**Output page:** Publisher Calendar / Content Collection
...
**Output page:** Unified Analytics / Publisher Calendar
...
**Output page:** Unified Analytics / VoC Survey Detail
...
*Catalog of 100 AI-generated flows. Each entry: Persona, File, Scenario. No step-by-step demo — reference only.*
...
**Persona:** Content Lead
**File:** `flows/approval-flow-bottleneck.js`  
...
**Persona:** Brand Manager
**File:** `flows/brand-voice-refresh.js`  
...
**File:** `flows/linkedin-document-campaign.js`  
...
**File:** `flows/product-launch-campaign.js`  
...
**Persona:** Content Lead
**File:** `flows/evergreen-content-recycler.js`  
...
**Persona:** Global Social Manager
**File:** `flows/multi-market-localization.js`  
...
**File:** `flows/dark-post-testing.js`  
...
**File:** `flows/whatsapp-templates.js`  
...
**Persona:** Care Supervisor
**File:** `flows/sla-breach-prevention.js`  
...
**Persona:** Care Manager
**File:** `flows/multilingual-inbox.js`  
...
**Persona:** Paid Social Manager
**File:** `flows/ad-comment-moderation.js`  
...
**Persona:** Reputation Manager
**File:** `flows/google-review-response.js`  
...
#### 18. Smart Escalation
**Persona:** Care Manager
**File:** `flows/smart-escalation.js`  
...
**Persona:** Care Supervisor
**File:** `flows/vip-customer-detection.js`  
...
**Persona:** Care Manager
**File:** `flows/agent-burnout-prevention.js`  
...
**Persona:** Brand Manager
**File:** `flows/sentiment-spike-alert.js`  
...
**File:** `flows/share-of-voice-battle.js`  
...
**Persona:** Insights Analyst
**File:** `flows/reddit-monitoring-setup.js`  
...
**Persona:** Marketing Manager
**File:** `flows/campaign-insights-report.js`  
...
**Persona:** Insights Analyst
**File:** `flows/audience-insights-board.js`  
...
**Persona:** Insights Analyst
**File:** `flows/listening-query-cleanup.js`  
...
**Persona:** Brand Manager
**File:** `flows/executive-briefing.js`  
...
**File:** `flows/product-feedback-loop.js`  
...
**Persona:** Influencer Manager
**File:** `flows/influencer-spike-detection.js`  
...
**Persona:** Social Media Manager
**File:** `flows/tiktok-topic-tracker.js`  
...
**Persona:** eCommerce Manager
**File:** `flows/seasonal-review-surge.js`  
...
**Persona:** Reputation Manager
**File:** `flows/negative-review-cluster.js`  
...
**Persona:** eCommerce Manager
**File:** `flows/ugc-gallery-refresh.js`  
...
**Persona:** eCommerce Manager
**File:** `flows/review-syndication-setup.js`  
...
**Persona:** eCommerce Manager
**File:** `flows/review-incentive-campaign.js`  
...
**Persona:** Bot Manager
**File:** `flows/bot-handoff-optimization.js`  
...
**Persona:** Bot Manager
**File:** `flows/faq-bot-expansion.js`  
...
**Persona:** Care Manager
**File:** `flows/after-hours-bot-config.js`  
...
**File:** `flows/flow-automation-setup.js`  
...
**Persona:** Bot Manager
**File:** `flows/intent-retraining.js`  
...
**Persona:** Influencer Manager
**File:** `flows/influencer-campaign-launch.js`  
...
**Persona:** Paid Social Manager
**File:** `flows/paid-campaign-alert.js`  
...
**Persona:** Influencer Manager
**File:** `flows/ugc-influencer-pipeline.js`  
...
**Persona:** Paid Social Manager
**File:** `flows/cross-platform-budget-optimizer.js`  
...
**Persona:** Paid Social Manager
**File:** `flows/lookalike-audience-builder.js`  
...
**Persona:** Social Media Director
**File:** `flows/approval-workflow-redesign.js`  
...
**Persona:** Care Operations
**File:** `flows/label-taxonomy-cleanup.js`  
...
**Persona:** Social Media Director
**File:** `flows/quarterly-review-prep.js`  
...
**Persona:** Global Social Manager
**File:** `flows/new-market-onboarding.js`  
...
**Persona:** Platform Admin
**File:** `flows/platform-health-audit.js`  
...
**Persona:** Content Director
**File:** `flows/autonomous-content-pipeline.js`  
...
**Persona:** Brand Manager
**File:** `flows/cross-module-spike-response.js`  
...
**File:** `flows/smart-budget-reallocation.js`  
...
**File:** `flows/ab-creative-experiment.js`  
...
**Persona:** Brand Manager
**File:** `flows/visual-ugc-brand-detection.js`  
...
**Persona:** Brand Strategist
**File:** `flows/competitive-benchmark-alert.js`  
...
**Persona:** Social Media Manager
**File:** `flows/anomaly-auto-correction.js`  
...
**Persona:** Brand Manager
**File:** `flows/employee-advocacy-launch.js`  
...
**File:** `flows/multi-agent-care-resolution.js`  
...
**Persona:** CX Manager
**File:** `flows/customer-onboarding-journey.js`  
...
**Persona:** eCommerce Manager
**File:** `flows/post-purchase-care.js`  
...
#### 68. CX Weekly Digest
**Persona:** CX Director
**File:** `flows/cx-weekly-digest.js`  
...
**File:** `flows/analytics-dashboard-migration.js`  
...
**Persona:** Marketing Director
**File:** `flows/social-roi-report.js`  
...
**Persona:** Content Strategist
**File:** `flows/content-performance-audit.js`  
...
**Persona:** Marketing Analyst
**File:** `flows/paid-vs-organic-attribution.js`  
...
**Persona:** Event Marketing Manager
**File:** `flows/real-time-event-tracking.js`  
...
**Persona:** Analytics Manager
**File:** `flows/data-quality-audit.js`  
...
**Persona:** Insights Analyst
**File:** `flows/listening-to-ua-board.js`  
...
**Persona:** Social Media Director
**File:** `flows/annual-report-prep.js`  
...
**Persona:** Brand Strategist
**File:** `flows/sov-tracker-setup.js`  
...
**Persona:** Retail Marketing Manager
**File:** `flows/retail-seasonal-campaign.js`  
...
**File:** `flows/finance-compliance-review.js`  
...
**File:** `flows/b2b-linkedin-program.js`  
...
**Persona:** Reputation Manager
**File:** `flows/hospitality-reputation.js`  
...
**Persona:** Healthcare Marketing Manager
**File:** `flows/healthcare-social-monitoring.js`  
...
**Persona:** eCommerce Manager
**File:** `flows/ecommerce-product-launch.js`  
...
**Persona:** Franchise Marketing Manager
**File:** `flows/franchise-governance.js`  
...
**Persona:** Care Manager
**File:** `flows/telco-care-automation.js`  
...
**Persona:** Brand Manager
**File:** `flows/cpg-ugc-amplification.js`  
...
**Persona:** Communications Director
**File:** `flows/media-realtime-response.js`  
...
**Persona:** Social Media Director
**File:** `flows/q3-strategy-kickoff.js`  
...
**Persona:** Marketing Director
**File:** `flows/board-reporting-package.js`  
...
**File:** `flows/brand-health-quarterly.js`  
...
**Persona:** Social Media Director
**File:** `flows/team-performance-review.js`  
...
**Persona:** Marketing Director
**File:** `flows/ai-governance-rollout.js`  
...
**Persona:** Global Social Manager
**File:** `flows/market-expansion-setup.js`  
...
**Persona:** Marketing Director
**File:** `flows/budget-reforecast.js`  
...
**Persona:** Marketing Manager
**File:** `flows/agency-brief-builder.js`  
...
**Persona:** Social Media Director
**File:** `flows/vendor-evaluation.js`  
...
**Persona:** Communications Director
**File:** `flows/crisis-preparedness-audit.js`  
...
*Inspired by competitive analysis of Sprinklr and Sprout Social — translated into Emplifi/Cortex context. Format: Persona, File, Scenario (reference only).*

### Group M: Sprinklr Service AI

#### 101. Contact Driver Discovery
**Persona:** Bot Manager
**File:** `flows/contact-driver-discovery.js`  
...
**File:** `flows/statistical-stories.js`  
...
**Persona:** Care Supervisor
**File:** `flows/agent-nudge-setup.js`  
...
**Persona:** Care Operations
**File:** `flows/acw-autofill-config.js`  
...
**Persona:** Care Manager
**File:** `flows/smart-response-training.js`  
...
**Persona:** Care Supervisor
**File:** `flows/care-agent-onboarding-ai.js`  
...
**Persona:** Care Director
**File:** `flows/quality-management-ai.js`  
...
**Persona:** Care Operations
**File:** `flows/case-routing-automation.js`  
...
**Persona:** Bot Manager
**File:** `flows/voice-bot-tts-setup.js`  
...
**Persona:** Care Operations
**File:** `flows/dynamic-workflow-builder.js`  
...
**Persona:** Brand Analyst
**File:** `flows/sentiment-shift-alert.js`  
...
**Persona:** Brand Strategist
**File:** `flows/competitor-benchmark-ai.js`  
...
**File:** `flows/trend-report-generator.js`  
...
**File:** `flows/campaign-lift-analysis.js`  
...
**Persona:** Research Analyst
**File:** `flows/custom-taxonomy-builder.js`  
...
**Persona:** PR Manager
**File:** `flows/media-monitoring-setup.js`  
...
**Persona:** Influencer Manager
**File:** `flows/influencer-sentiment-scan.js`  
...
**Persona:** Brand Strategist
**File:** `flows/audience-intent-signals.js`  
...
**Persona:** Marketing Director
**File:** `flows/share-of-voice-tracker.js`  
...
**Persona:** Research Analyst
**File:** `flows/listening-query-optimizer.js`  
...
**Persona:** Campaign Manager
**File:** `flows/ai-campaign-brief.js`  
...
**Persona:** Global Marketing Manager
**File:** `flows/content-localizer.js`  
...
**File:** `flows/channel-mix-optimizer.js`  
...
**Persona:** Paid Social Manager
**File:** `flows/ad-creative-rotator.js`  
...
**Persona:** Compliance Manager
**File:** `flows/compliance-content-shield.js`  
...
**Persona:** Campaign Manager
**File:** `flows/budget-pacing-alert.js`  
...
**Persona:** Content Strategist
**File:** `flows/content-performance-predictor.js`  
...
**Persona:** Brand Manager
**File:** `flows/multi-brand-content-sync.js`  
...
**File:** `flows/paid-organic-amplifier.js`  
...
**Persona:** Brand Manager
**File:** `flows/creative-brand-voice-check.js`  
...
**File:** `flows/trellis-case-triage.js`  
...
**Persona:** Care Operations Manager
**File:** `flows/autonomous-care-resolver.js`  
...
**Persona:** Community Manager
**File:** `flows/social-inbox-zero.js`  
...
**Persona:** Care Manager
**File:** `flows/smart-escalation-paths.js`  
...
**Persona:** Analytics Manager
**File:** `flows/trellis-report-builder.js`  
...
**Persona:** Head of CX
**File:** `flows/cross-channel-care-view.js`  
...
**Persona:** Care Innovator
**File:** `flows/proactive-care-trigger.js`  
...
**Persona:** Brand Manager
**File:** `flows/ai-review-moderation.js`  
...
**Persona:** Care Team Lead
**File:** `flows/shift-handover-summary.js`  
...
**Persona:** Care Operations Manager
**File:** `flows/care-capacity-forecasting.js`  
...
**Persona:** Social Media Manager
**File:** `flows/ai-caption-optimizer.js`  
...
**File:** `flows/hashtag-intelligence.js`  
...
**Persona:** Social Media Manager
**File:** `flows/best-time-to-post.js`  
...
**Persona:** Content Strategist
**File:** `flows/content-repurposer.js`  
...
**Persona:** Brand Analyst
**File:** `flows/ai-listening-insights.js`  
...
**Persona:** Social Media Manager
**File:** `flows/engagement-rate-recovery.js`  
...
**File:** `flows/ugc-curation-automation.js`  
...
**Persona:** CRM Manager
**File:** `flows/social-customer-profiles.js`  
...
**Persona:** Content Strategist
**File:** `flows/content-pillar-ai.js`  
...
**Persona:** CMO
**File:** `flows/social-roi-attribution.js`  
...
**Persona:** Influencer Marketing Manager
**File:** `flows/creator-discovery-ai.js`  
...
**Persona:** Influencer Manager
**File:** `flows/influencer-fraud-detection.js`  
...
**Persona:** Influencer Campaign Manager
**File:** `flows/creator-brief-generator.js`  
...
**File:** `flows/influencer-roi-tracker.js`  
...
**Persona:** Content Manager
**File:** `flows/ugc-rights-campaign.js`  
...
**Persona:** Performance Marketing Manager
**File:** `flows/creator-content-amplifier.js`  
...
**Persona:** Influencer Director
**File:** `flows/creator-portfolio-audit.js`  
...
**Persona:** Community Manager
**File:** `flows/ambassador-program-ai.js`  
...
**Persona:** Head of Digital CX
**File:** `flows/microsoft-scale-care.js`  
...
**Persona:** Global Social Media Director
**File:** `flows/samsung-global-social.js`  
...
#### 163. UGC at Scale
**Persona:** Digital Content Director
**File:** `flows/mcdonalds-ugc-scale.js`  
...
**Persona:** Creator Marketing VP
**File:** `flows/nike-creator-network.js`  
...
**Persona:** Legal & Compliance Manager
**File:** `flows/disney-compliance-shield.js`  
...
**Persona:** Global Insights Director
**File:** `flows/unilever-insight-engine.js`  
...
#### 167. Crisis War Room
**Persona:** Crisis Communications Director
**File:** `flows/t-mobile-crisis-war-room.js`  
...
**Persona:** Healthcare Marketing Compliance
**File:** `flows/pfizer-regulated-content.js`  
...
**Persona:** Financial Services Social Media Manager
**File:** `flows/barclays-financial-social.js`  
...
**Persona:** Retail Social Media Director
**File:** `flows/holiday-season-scaling.js`  
...
**File:** `flows/agency-client-reporting.js`  
...
**Persona:** Brand Launch Manager
**File:** `flows/retail-product-launch.js`  
...
**Persona:** eCommerce Customer Service Manager
**File:** `flows/ecommerce-social-care.js`  
...
**Persona:** Patient Experience Manager
**File:** `flows/healthcare-patient-care.js`  
...
**Persona:** Automotive Digital Marketing Manager
**File:** `flows/automotive-care-ai.js`  
...
**Persona:** B2B Social Media Manager
**File:** `flows/b2b-social-selling.js`  
...
**Persona:** Digital Media Manager
**File:** `flows/media-company-social.js`  
...
**Persona:** Community Engagement Manager
**File:** `flows/nonprofit-community.js`  
...
**Persona:** Sports Digital Media Manager
**File:** `flows/sports-team-fan-care.js`  
...
**Persona:** Franchise Social Media Manager
**File:** `flows/restaurant-chain-social.js`  
...
**Persona:** Head of Digital CX
**File:** `flows/commerce-care-bridge.js`  
...
**File:** `flows/ratings-review-response-ai.js`  
...
**Persona:** VP Marketing
**File:** `flows/three-cloud-campaign.js`  
...
#### 184. UGC to Commerce
**Persona:** eCommerce Content Manager
**File:** `flows/ugc-to-commerce.js`  
...
**Persona:** eCommerce Director
**File:** `flows/social-proof-engine.js`  
...
**File:** `flows/care-to-commerce-recovery.js`  
...
**Persona:** Brand Reputation Manager
**File:** `flows/review-velocity-alert.js`  
...
**Persona:** Influencer Marketing Manager
**File:** `flows/influencer-commerce-tie.js`  
...
**File:** `flows/content-hub-ai-curation.js`  
...
**Persona:** Social Commerce Manager
**File:** `flows/social-commerce-dashboard.js`  
...
**Persona:** Head of Social Innovation
**File:** `flows/cortex-memory-learning.js`  
...
**File:** `flows/ai-governance-setup.js`  
...
**Persona:** Social Innovation Manager
**File:** `flows/cortex-skill-builder.js`  
...
**Persona:** Digital Operations Director
**File:** `flows/multi-agent-orchestration.js`  
...
#### 197. AI Audit Trail
**Persona:** Compliance Director
**File:** `flows/ai-audit-trail.js`  
...
**File:** `flows/predictive-crisis-prevention.js`  
...
**Persona:** Trust & Safety Manager
**File:** `flows/ai-content-moderation.js`  
...
**Persona:** VP Digital Strategy
**File:** `flows/cortex-roi-dashboard.js`  
