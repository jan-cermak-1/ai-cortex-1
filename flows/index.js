...
const FLOWS_REGISTRY = [
  ...
  // ── PMs: 100x Opportunities (Anton's table, Emplifi PM) ───────────────
  { id: 'pm-360-analytics', name: '360 Analytics', description: 'Execute 360 analysis of marketing data across all areas', persona: 'VP Marketing', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_360_ANALYTICS },
  { id: 'pm-dynamic-roi-marketing-mix', name: 'Dynamic ROI & Marketing Mix Re-Alignment', description: 'Re-calibrate KPIs and budget allocation when objectives change', persona: 'VP Marketing / CMO', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_DYNAMIC_ROI_MARKETING_MIX },
  { id: 'pm-social-media-campaign', name: 'Social Media Campaign (Organic)', description: 'Draft cross-platform organic campaign aligned with brand voice', persona: 'Social Media Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_SOCIAL_MEDIA_CAMPAIGN },
  { id: 'pm-social-media-schedule', name: 'Social Media Schedule', description: 'Detect scheduling gaps, off-peak times, insufficient coverage', persona: 'Social Media Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_SOCIAL_MEDIA_SCHEDULE },
  { id: 'pm-ugc-vetting-autopermission', name: 'UGC Vetting and Autopermissioning', description: 'Auto-sort UGC by quality; auto-request permissions', persona: 'Influencer Marketing Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_UGC_VETTING_AUTOPERMISSION },
  { id: 'pm-brand-guardian', name: 'The Brand Guardian (Recovery & Action)', description: 'Diagnose follower churn and generate recovery plan', persona: 'PR Director', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_BRAND_GUARDIAN },
  { id: 'pm-global-ad-auto-labeling', name: 'Intelligent Auto-Labeling for Global Ad Campaigns', description: 'Globally consistent auto-labeling across 130+ ad accounts', persona: 'Global Head of Social', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_GLOBAL_AD_AUTO_LABELING },
  { id: 'pm-automation-assessment', name: 'Automation Assessment', description: 'Analyze Bot performance and recommend improvements', persona: 'Customer Care Director', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_AUTOMATION_ASSESSMENT },
  { id: 'pm-autonomous-label-governance', name: 'Autonomous Label Governance Agent', description: 'Autonomous labeling; filter noise; ensure reporting-ready data', persona: 'Community Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_AUTONOMOUS_LABEL_GOVERNANCE },
  { id: 'pm-tier1-case-resolver', name: 'Autonomous Tier-1 Case Resolver', description: 'AI autonomously resolves repetitive Tier-1 cases within guardrails', persona: 'Head of Customer Service', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_TIER1_CASE_RESOLVER },
  { id: 'pm-sla-breach-prevention', name: 'SLA Breach Prevention Operator', description: 'AI proactively prevents SLA breaches before they happen', persona: 'Contact Center Supervisor', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_SLA_BREACH_PREVENTION },
  { id: 'pm-ai-workflow-builder', name: 'AI Workflow Builder from Plain English', description: 'Generate fully configured workflow from natural language', persona: 'Operations Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_AI_WORKFLOW_BUILDER },
  { id: 'pm-conversation-auto-coach', name: 'Conversation Intelligence Auto-Coach', description: 'AI continuously evaluates and coaches agents', persona: 'Team Lead', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_CONVERSATION_AUTO_COACH },
  { id: 'pm-case-summarization-handoff', name: 'Autonomous Case Summarization & Handoff', description: 'Instant structured case handoff summaries', persona: 'Contact Center Agent', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_CASE_SUMMARIZATION_HANDOFF },
  { id: 'pm-self-healing-kb', name: 'Self-Healing Knowledge Base', description: 'AI detects outdated content and drafts improved versions', persona: 'Knowledge Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_SELF_HEALING_KB },
  { id: 'pm-knowledge-gap-detector', name: 'Knowledge Gap Detector', description: 'AI identifies and drafts missing KB articles', persona: 'Head of CS', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_KNOWLEDGE_GAP_DETECTOR },
  { id: 'pm-confidence-auto-resolution', name: 'Confidence-Based Auto Resolution Engine', description: 'Allow autonomous resolution only when confidence threshold met', persona: 'CX Director', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_CONFIDENCE_AUTO_RESOLUTION },
  { id: 'pm-continuous-learning-loop', name: 'Continuous Learning Loop Agent', description: 'Closed-loop system that improves autonomy monthly', persona: 'VP Customer Experience', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_CONTINUOUS_LEARNING_LOOP },
  { id: 'pm-nl-reporting-operator', name: 'Natural Language Reporting Operator', description: 'Generate executive-ready report from natural language', persona: 'Operations Director', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_NL_REPORTING_OPERATOR },
  { id: 'pm-autonomous-governance-architect', name: 'Autonomous Governance Architect', description: 'Design optimal Teams structure based on org, regions, workflows', persona: 'Platform Admin', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_AUTONOMOUS_GOVERNANCE_ARCHITECT },
  { id: 'pm-intelligent-onboarding-concierge', name: 'Intelligent Onboarding Concierge', description: 'Auto-provision correct teams and roles for new/changing users', persona: 'Team Admin', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_INTELLIGENT_ONBOARDING_CONCIERGE },
  { id: 'pm-continuous-governance-guardian', name: 'Continuous Governance Guardian', description: 'Full visibility of governance health; auto-correct risks', persona: 'Platform Admin', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_CONTINUOUS_GOVERNANCE_GUARDIAN },
  { id: 'pm-realtime-competitive-intelligence', name: 'Real-Time Competitive Intelligence & Benchmarking Engine', description: 'Track competitors; identify winning strategies; alert on content gaps', persona: 'Marketing Analyst', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_REALTIME_COMPETITIVE_INTELLIGENCE },
  { id: 'pm-guided-workspace-architect', name: 'Guided Agentic Workspace Architect', description: 'Fully configured, industry-specific workspace in minutes', persona: 'Implementation Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_GUIDED_WORKSPACE_ARCHITECT },
  { id: 'pm-ai-logic-guardrail', name: 'AI Logic Guardrail & Flow Optimizer', description: 'Flag logical dead-ends before Activate is clicked', persona: 'Operations Manager', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_AI_LOGIC_GUARDRAIL },
  { id: 'pm-proactive-workflow-discovery', name: 'Proactive Workflow Discovery Agent', description: 'Detect repetitive behavior; propose automation', persona: 'Customer Support Agent', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_PROACTIVE_WORKFLOW_DISCOVERY },
  { id: 'pm-intelligent-keyword-analyzer', name: 'Intelligent Keyword Analyzer', description: 'Dynamic keyword lists from real-world user language', persona: 'Marketing Analyst', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_INTELLIGENT_KEYWORD_ANALYZER },
  { id: 'pm-unified-commerce-signal-agent', name: 'Unified Commerce Signal Agent (UCSA)', description: 'Detect cross-channel sentiment shifts; predict revenue risk', persona: 'VP of Ecommerce', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_UNIFIED_COMMERCE_SIGNAL_AGENT },
  { id: 'pm-conversion-driving-review-intelligence', name: 'Conversion-Driving Review Intelligence Agent', description: 'Identify reviews that drive conversion; shape future collection', persona: 'VP of Ecommerce / CRO Lead', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_CONVERSION_DRIVING_REVIEW_INTELLIGENCE },
  { id: 'pm-revenue-recovery-objection-intercept', name: 'Revenue Recovery & Objection Intercept Agent (RROIA)', description: 'Intercept buyer objections in real time using review intelligence', persona: 'VP of Ecommerce / CRO Lead', startPage: 'command-center.html', source: 'pm', data: FLOW_PM_REVENUE_RECOVERY_OBJECTION_INTERCEPT }
];
